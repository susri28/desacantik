...
<body>
    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                    <a href="index.php"><img src="../cantik.png" alt="cantik" width="100%"></a>
            </div>
            <div class="main-menu">
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                <a href="stock.php"><i class="ti-dashboard"></i><span>Input Data</span></a>
                            </li>
							<li>
                                <a href="javascript:void(0)" aria-expanded="true"><i class="ti-layout"></i><span>Transaksi Data
                                    </span></a>
                                <ul class="collapse">
                                    <li><a href="masuk.php">Daftar Input</a></li>
                                </ul>
                            </li>
                            <li>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="market-status-table mt-4">
                                    <iframe src="https://forms.zohopublic.com/susrihaningsih28/form/DesaCantik2022/formperma/-mjcUzk7jFjBmAFd68WvWfmbn66jhoqDfs_bRm2Dflw" width="1000" height="500" frameborder="0" marginheight="0" marginwidth="0" >Memuat…</iframe>
    ...
    <div class="pull-right">
        <img src="../BPS.png" alt="BPS" width="40px">
    </div>
    <strong>Copyright &copy; 2022 Badan Pusat Statistik Kota Semarang</a></strong>
</footer>
